...
set/delete. `T202C3-A002` completed review at production commit `2c00f32` and
owns the exact account-update transition plus provisional-to-ready cleanup rows.
Account remove is the next bounded attempt after explicit A002 acceptance;
