...
`T202C3-A003` is Ready and owns the account-remove transition, preserved removed
history, store-only after versioning, and cleanup readiness. Credential
transitions and cleanup claim/delete remain later serial attempts.
Priority: P0
Story / Requirement: US-001, US-003; FR-003-FR-009, FR-016; NFR-001-NFR-003,
NFR-006, NFR-007
